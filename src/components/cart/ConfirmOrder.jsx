            ...
            <div className="row d-flex justify-content-between">
                            ...
                            <div className="cart-item my-1">
                                <div className="row">
                                    ...
                                    <div className="col-4 col-lg-4 mt-4 mt-lg-0">
                                        <p>{item?.quantity} x ${item?.price} = <b>${(item?.price * item?.quantity).toFixed(2)}</b></p>
                                    </div>
                                </div>
                            </div>
                            <hr />
                ...
                <div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        <h4>Order Summary</h4>
                        <hr />
                        <p>Item Price: <span className="order-summary-values">${itemsPrice}</span></p>
                        ...
                        <hr />
                        <Link to="/payment_method" id="checkout_btn" className="btn btn-danger w-100">
                            Proceed to Payment
                        </Link>
                    </div>
                </div>
